...
public class game1vComp extends Pane {
    ...
    static boolean ProcessingFlag = true;

    static Vector<ImageView> randList = new Vector<ImageView>();
    static int Myvalue;
    ...
    static int[] oList = new int[9];
    static int[] oFlagList = new int[9];
...
//                }
        ...
        var1.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var1Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var1.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    System.out.println("im here");
                    XOFlag = 'o';
                    var1Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ).toExternalForm()));
                    x1 = 1;
                    counteArr[count] = 1;
                    count++;
                    ...
                    var1.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var1Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
                    ).toExternalForm()));
                    o1 = 1;
                    counteArr[count] = 1;
                    count++;
        ...
        var2.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var2Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var2.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var2Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var2.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var2Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var3.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var3Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var3.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var3Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var3.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var3Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var4.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var4Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var4.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var4Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var4.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var4Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var5.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var5Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var5.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var5Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var5.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var5Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var6.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var6Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var6.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var6Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var6.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var6Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var7.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var7Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var7.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var7Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var7.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var7Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var8.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var8Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var8.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var8Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var8.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var8Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
        ...
        var9.setOnMousePressed(new EventHandler<javafx.scene.input.MouseEvent>() {
            ...
            public void handle(javafx.scene.input.MouseEvent evt) {
                ...
                if (XOFlag == 'x' && var9Flag == 1 && gameFinishedFlag == false && ProcessingFlag == true) {
                    var9.setImage(new Image(game1vComp.this.getClass().getResource("jerry.jpg"
                    ).toExternalForm()));
                    XOFlag = 'o';
                    var9Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("tturn.jpg"
                    ...
                    var9.setImage(new Image(game1vComp.this.getClass().getResource("tom.jpg"
                    ).toExternalForm()));
                    XOFlag = 'x';
                    var9Flag = 0;
                    replayBtn1.setImage(new Image(game1vComp.this.getClass().getResource("jturn.jpg"
    ...
    public void checkFinishing() {
        ...
        System.out.println("tic.game1vComp.checkFinishing()");
...
//    nova5.inGameFlag =true;
    ...
    public void generateRand() {
        ...
        for (int i = 0; i < game1vComp.counteArr.length; i++) {
            if (value == game1vComp.counteArr[i]) {
                existFlag = false;
                break;
            } else {
                existFlag = true;
...
//    
//    for(int i=0;i<game1vComp.counteArr.length;i++){
//        System.out.println(game1vComp.counteArr[i]+"   "+ value);
//       
//    }    
//        
//        //test.myText.setText(value.toString());
//        game1vComp.ProcessingFlag=!game1vComp.ProcessingFlag;
//        if(game1vComp.ProcessingFlag){
//         
//         game1vComp.comp(value);
//            
//            
//            
//            stop();}
