...
public  class jWin extends Pane {
    ...
    public jWin() {
        ...
        no.setLayoutX(-5.0);
        no.setLayoutY(-7.0);
        no.setImage(new Image(getClass().getResource("jwin.gif").toExternalForm()));

        text.setFill(javafx.scene.paint.Color.valueOf("#eeff00"));
        text.setLayoutX(286.0);
        text.setLayoutY(73.0);
        text.setStrokeType(javafx.scene.shape.StrokeType.OUTSIDE);
        text.setStrokeWidth(0.0);
        text.setText("Jerry Win - X");
        ...
        Tic.stage2.setScene(scene);
        Tic.stage2.show();}
              else if(Tic.gamePhase==2){ root = new nova5();
              Scene scene = new Scene(root);        
        Tic.stage2.setScene(scene);
        Tic.stage2.show();}
